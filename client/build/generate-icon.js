 ...
 * 1. 从官方 favicon.svg 提取鲸鱼 path，重着色为品牌主色 #3964fe
 * 2. 用 sharp 栅格化为透明背景 PNG（512/256/128/64/48/32/24/16）
 * 3. 组装为 PNG-embedded 多尺寸 ICO，并输出 icon.png（512）
 */
const sharp = require(process.env.SHARP_ABS || 'D:/Program Files (x86)/node_modules/sharp')
const fs = require('fs')
const path = require('path')

const BRAND = '#000000'
const SRC = 'D:/deepseek-harness/client/staging/app/resources/dsh-runtime/node_modules/@deepseek-ai/dsh-web-frontend/dist/favicon.svg'
